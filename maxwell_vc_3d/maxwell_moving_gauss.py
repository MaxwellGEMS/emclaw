...
material = Material3D(shape='moving_gauss',metal=False)
material.bkg_eta.fill(1.5)
material.dim = 'xyz'
material.setup()
material.sigma.fill(2.5)
material.offset[1,:].fill(mid_point_y)
material.offset[2,:].fill(mid_point_z)
...
def em3D(mx=128,my=128,mz=128,num_frames=10,cfl=1.0,outdir='./_output',before_step=True,debug=False):
