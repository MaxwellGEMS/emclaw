...
def grid_basic(x_lower,x_upper,mx,cfl):
    ...
    tf = (x_upper-x_lower+10.0)/source.v

    return dx,dt,tf

def em1D(mx=2**11,num_frames=100,cfl=1.0,outdir='./_output',before_step=True,debug=False,velocity=0.59,chi3=0.0):
