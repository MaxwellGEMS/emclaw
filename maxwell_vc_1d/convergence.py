...
def em1D(mx=4096,num_frames=100,cfl=1.0,outdir='./_output',before_step=True,debug=False,velocity=0.59,chi3=0.0,chi2=0.0,em=True):
    import clawpack.petclaw as pyclaw
    import petsc4py.PETSc as MPI

    material.delta_velocity_e = velocity
    material.delta_velocity_m = velocity
